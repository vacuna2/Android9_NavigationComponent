...
public class OperacionesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_operaciones,container,false);
        txtnr1 = view.findViewById(R.id.nro1);
        txtnr2 = view.findViewById(R.id.nr2);
        btn1 = view.findViewById(R.id.SUMA);

        btn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(getActivity(), "La suma es: " + String.valueOf(Double.parseDouble(txtnr1.getText().toString()) + Double.parseDouble(txtnr2.getText().toString())), Toast.LENGTH_SHORT).show();
            }
        });
        return view;
